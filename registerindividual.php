...
$sql=("INSERT INTO individuals(name, phone, dob, email, username, pass, image, membership) VALUES('$name', '$phone', '$dob', '$email', '$username', '$hashedpass', '$img', '$membership')");

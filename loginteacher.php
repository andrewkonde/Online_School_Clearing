...
//----------------------------------------------------------------------------------------------
$s="SELECT username FROM teachers WHERE username='$username'";
...
$sql="SELECT pass FROM teachers WHERE username='$username'";
...
$sql3="SELECT image FROM teachers WHERE username='$username'";
...
while($row= mysqli_fetch_array($result)){
	...
	//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
	$sql4="SELECT schoolcode FROM registeredteachers WHERE username='$username'";

...
<head>
<title>System Admin Space</title>
...
//**********************************************************************************
echo '<h2>Institutions   <form action="#"><button type="submit">Add</button></form></h2>';
...
echo '<table border="2" cellspacing="2" cellpadding="2"> 
      <tr> 
          ...
          <td> <font face="Arial"><h3>SCHOOL CODE</h3></font> </td> 
          <td> <font face="Arial"><h3>NAME</h3></font> </td> 
          <td> <font face="Arial"><h3>COUNTY</h3></font> </td> 
          <td> <font face="Arial"><h3>P.O. BOX</h3></font> </td> 
		  <td> <font face="Arial"><h3>FOUNDED YEAR</h3></font> </td> 
          <td> <font face="Arial"><h3>EMAIL ADDRESS</h3></font> </td> 
		  <td> <font face="Arial"><h3>PHONE NUMBER</h3></font> </td> 
		  <td> <font face="Arial"><h3>DATE JOINED</h3></font> </td> 
		  <td> <font face="Arial"><h3>LOGO</h3></font> </td>
          <td> <font face="Arial"><h3>Action</h3></font> </td>		  
      </tr>';
	  

if ($result = $connection->query($query)) {
	$totalinstitutions= mysqli_num_rows($result);
    while ($row = $result->fetch_assoc()) {
		...
		/*
		for($i=0; $i<$totalinstitutions; $i+1){
			$_SESSION['schcode']=$schoolcode[$i];
		}
		*/
		
		$_SESSION['schcode']=$schoolcode;

        $action = '<form action="exploreinstitutions.php"><button type="submit">Explore</button></form>';			
        ...
        echo '<tr> 
				  ...
				  <td>'.$phone.'</td> 
				  <td>'.$datejoined.'</td> 
				  <td><img src="data:image/jpeg;base64,'.base64_encode($logo).'" width="100px" height="100px"></td>
				  <td>'.$action.'</td> 				  
              </tr>';
    }
    //$result->free();
...
echo "alert('Institutions not Found! Please try again.');";
echo "</script>";
$URL="systemadminspace.php";
echo "<script>location.href='$URL'</script>";
}
echo '</table>';
echo "Total Institutions: ".$totalinstitutions;

echo '<br>';
echo '<br>';
//--------------------------------------------------------------------------------------------------------------------------------------------------------
echo '<h2>Subjects   <form action="addsubjects.html"><button type="submit">Add</button></form></h2>';
...
echo '<table border="2" cellspacing="2" cellpadding="2"> 
      <tr> 
          <td> <font face="Arial"><h3>ID</h3></font> </td> 
          <td> <font face="Arial"><h3>SUBJECT CODE</h3></font> </td> 
          <td> <font face="Arial"><h3>SUBJECT NAME</h3></font> </td> 
      </tr>';
...
echo "<script language='javascript' type='text/javascript'>";
echo "alert('Subjects not Found! Please try again.');";
echo "</script>";
$URL="systemadminspace.php";
echo "<script>location.href='$URL'</script>";
}

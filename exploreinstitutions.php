...
<head>
<title>System Admin Explore Institution</title>
...
<?php
		...
		$schoolcode=$_SESSION['schcode'];

echo '<br>';
echo '<form action="systemadminspace.php"><button type="submit"><h2>System Admin Space</h2></button></form>';
echo '<br>';

//**********************************************************************************
echo '<h2>Students   <form action="#"><button type="submit">Add</button></form></h2>';

$query="SELECT * FROM registeredstudents WHERE schoolcode='$schoolcode'";
...
echo '<br>';
//--------------------------------------------------------------------------------------------------------------------------------------------------------
echo '<h2>Teachers   <form action="#"><button type="submit">Add</button></form></h2>';

$query="SELECT * FROM registeredteachers WHERE schoolcode='$schoolcode'";
